        ...
        <div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div className={styles.carouselPlansFinalCC}>
                        ...
                        <div className={styles.paymentMethodFinalCC}>
                            <div className={styles.paymentMethodFinalCheckmarkCC} />
                            <div className={styles.paymentMethodFinalTitleCC}>Pagamento concluído</div>
                            <div className={styles.paymentMethodFinalText1CC}>Seu pagamento foi concluído com sucesso.</div>
                            <div>
                                <div className={styles.paymentMethodFinalText2CC}>Nº do Pagamento:</div>
                                <div className={styles.paymentMethodFinalBox2TextCC}>ZRA19AB</div>
                            </div>
                        </div>
